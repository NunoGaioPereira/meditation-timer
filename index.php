            ...
            <div class="sound-picker">
                ...
                <button data-sound="./includes/sounds/beach.mp3" data-video="./includes/video/beach.mp4">
                    ...
                    <!-- <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                         viewBox="0 0 50 50" xml:space="preserve">
                        <g>
                            <path d="M1.2,34.7C1.1,34.6,1,34.3,1,34.2c0-0.5,0.5-0.7,1.5-0.7c3,0,5-0.5,8-2.6c2-1.4,4.4-4,6.3-6.6c1.7-2.4,3.3-4.2,5-5.4
                                c3.7-2.7,7.9-4.1,12.6-4.1c1.8,0,2.3,0,3.2,0.3c2.5,0.7,4.1,2.4,4.5,4.9c0.2,1,0.1,1.2-0.4,1.5c-0.3,0.1-0.4,0.1-0.9-0.2
                                c-0.9-0.6-1.8-0.8-2.9-0.7c-2.8,0.2-4.8,2.7-4.7,6c0.1,1.1,0.1,1.3,0.6,2.2c1.1,2.2,4.2,4.4,7.5,5.2c1.8,0.5,0.8,0.3,4.1,0.5
                                c3.3,0,3.4-0.3,3.4,0.3c0,0.6-0.2,0.7-2.7,0.8c-6.6,0-8.2-0.6-11.6-3.6c-2.8-2.4-3.5-6-2-9.2c1.3-2.7,4.3-4.2,7.2-3.5
                                c0.8,0.2,0.8,0.2,0.7-0.1c-0.2-0.5-0.6-1.1-1.2-1.7c-1.1-1-2.3-1.4-5-1.4c-2,0-3.1,0.1-4.7,0.5c-4.9,1.2-8.4,3.8-11.5,8.2
                                c-1.5,2.1-2.5,3.3-3.8,4.6c-4,3.9-6.5,5.1-11.7,5.5C1.6,34.9,1.4,34.9,1.2,34.7L1.2,34.7z"/>
                        </g>
                    </svg> -->
                    <!-- <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
